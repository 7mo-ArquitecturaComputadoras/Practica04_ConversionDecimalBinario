...
| Iteración | EAX (antes)    | Carry tras SHL | BL    | Carácter | buffer acumulado |
|-----------|----------------|----------------|-------|----------|------------------|
| 1         | `0xA8000000`   | `1`            | `'1'` | `'1'`    | `"1"`            |
| 2         | `0x50000000`   | `0`            | `'0'` | `'0'`    | `"10"`           |
| 3         | `0xA0000000`   | `1`            | `'1'` | `'1'`    | `"101"`          |
| 4         | `0x40000000`   | `0`            | `'0'` | `'0'`    | `"1010"`         |
| 5         | `0x80000000`   | `1`            | `'1'` | `'1'`    | `"10101"`        |
| 6         | `0x00000000`   | `0`            | `'0'` | `'0'`    | `"101010"`       |
